...
const Grid = React.forwardRef((props, ref) => {
    ...
    const passColorsToKeyboard = React.useCallback((comparisonArray, word) => {
    ...
    const flipTile = React.useCallback((comparisonArray, word) => {
    ...
    const compareToSolution = React.useCallback((word) => {
